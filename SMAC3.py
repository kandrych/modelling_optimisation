...
def main():
    ...
    p.add_argument("--share-zone-composition", action="store_true",
                   help="Copy zone 1's entire dust population to zone 2, including species, materials, sizes and heating methods")
