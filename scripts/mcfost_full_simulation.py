...
work_root='/Users/katerynaandrych/Work/lin/Postdoc/ozstar/for_conference_iras_08/chromatic/i10_pa100/'
fidelity={}
fidelity["stage"]='F3'
...
data_arg = obriy_smac.load_data('demo_mac', str(work_root),fidelity["stage"])
